...
class CLIP(nn.Module):
    ...
    def __init__(
        ...
        self.visual = _build_vision_tower(embed_dim, vision_cfg, quick_gelu, cast_dtype, te_fp8)

        text = _build_text_tower(embed_dim, text_cfg, quick_gelu, cast_dtype, te_fp8)
