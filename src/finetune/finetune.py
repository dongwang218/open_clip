...
from src.finetune.common import get_dataloader, maybe_dictionarize
from src.finetune.modeling import ClassificationHead, ImageEncoder, ImageClassifier
from src.finetune.utils import cosine_lr, torch_load, LabelSmoothing

from src.finetune import datasets
...
def finetune(args):
    ...
    dataset_class = getattr(datasets, args.train_data)
